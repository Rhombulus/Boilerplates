...
using Boilerplates.AspNet5.Mvc6beta5.Website_Individual.Models;

namespace Boilerplates.AspNet5.Mvc6beta5.Website_Individual.Migrations
{
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override void BuildModel(ModelBuilder builder)
        {
            ...
            builder.Entity("Boilerplates.AspNet5.Mvc6beta5.Website_Individual.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("Boilerplates.AspNet5.Mvc6beta5.Website_Individual.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
